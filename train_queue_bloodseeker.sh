...
GPU1=(
    "python train/train_supervised.py     --config plants/six_pendulum/config.py | supervised_six"
    "python train/train_pure.py           --config plants/six_pendulum/config.py | pure_six"
)
